  ...
  return (
    <div className="min-h-screen flex flex-col justify-between">
      <header className="flex justify-around items-center bg-sky-800/75 p-2 text-white z-50">
        ...
        <LocalizedLink to="/" className="aspect-square min-w-max">
          <StaticImage
            src="../../src/images/logoRound.png"
            alt="NBNR Logo"
            width={90}
            height={90}
      ...
      <footer
        className="flex flex-col sm:flex-row items-center sm:items-start bg-sky-800/75 text-white p-4
      ...
      >
        <div className="basis-2/5">
          ...
          <div className="mt-2">
            <div className="flex flex-col xl:flex-row xl:space-x-4 space-y-2 xl:space-y-0">
              <a
                href="https://www.instagram.com/nbnr.mnrn/"
              ...
              <a
                href="https://www.facebook.com/nbnr.mnrn/"
                className="flex space-x-1.5"
              >
                <StaticImage
              ...
              <a
                href="https://www.youtube.com/channel/UC9X4dG-fBwQ0fzSIoD063bw"
                className="flex space-x-1.5"
              >
                <StaticImage
                  src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b8/YouTube_Logo_2017.svg/langfr-1920px-YouTube_Logo_2017.svg.png"
                  alt="YouTube Logo"
                  width={45}
                  height={30}
              ...
              <a
                href={
                  intl.locale === "en-CA"
                    ...
                    : "https://forces.ca/fr/nous-joindre/"
                }
              >
                <StaticImage
                  src="../images/1920px-Canada_wordmark.svg.png"
                  alt="Canada"
                  width={170}
                  height={40}
                />
        ...
        <div className="basis-3/5">
          ...
          <ul className="list-none pl-8">
            <li>
              <intl.formatMessage id="Internal" />: +NAVRES HQ SSO BANDS
              NBNR@NAVRES HQ@Quebec
            </li>
            <li>
              <intl.formatMessage id="External" />:{" "}
              <a
                href="mailto:bands.navreshq_fanfares.qgresnav@forces.gc.ca"
                className="underline"
              >
                bands.navreshq_fanfares.qgresnav@forces.gc.ca
              </a>
            </li>
          </ul>
        </div>

...
const IndexPage = () => {
    return (
<div className={`bg-fixed bg-center bg-cover scroll-smooth overflow-auto touch-auto z-10 w-full h-full fixed block top-0 left-0 bg-no-repeat`} style={{backgroundImage: `url(${image2})`}}>
